...
public class FileUploadController {
	 ...
	 * 
	 * 1) enctype = "multipart/form-data로 클라이언트가 요청
	 * 		
	 * 2) Spring에 내장되어있는 MultipartResolver가
	 * 		제출된 파라미터들을 분류함
	 * 
	 * 		문자열, 숫자 -> String (으로 분류되어짐)
	 * 		파일 -> MultipartFile 인터페이스 구현한 객체
	 * 
	 * 3) 컨트롤러 메서드 매개변수로 전달
	 * 		(@RequestParam, @ModlAttribute)
	 */
	/**
	 * 단일 파일 업로드
	 * @return
