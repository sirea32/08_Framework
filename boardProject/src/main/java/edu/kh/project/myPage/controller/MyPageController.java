...
// 2. @SessionAttribute를(뒤에 s있고 없고 차이) 이용해
...
public class MyPageController {
	...
	public String info(
		...
		if(loginMember.getMemberAddress()!=null) {
			...
			// 주소를 ,(콤마) 기준으로 쪼개서 String[] 형태로 반환
			String[] arr = loginMember.getMemberAddress().split(",");
			// "04120, 서울 마포구 마포대로 195, ㅁㄴㅇ"
// -> {"04120", "서울 마포구 마포대로 195", "ㅁㄴㅇ"} -> 각각 배열 [0,1,2] 순
	 ...
	 * 					session에서 저장된 Member 객체의 주소 반환됨
	...
	public String updateInfo(
		...
		if(result>0) {
			...
			loginMember.setMemberAddress(loginMember.getMemberAddress());
		}
		else 				 message = "수정 실패..?";
