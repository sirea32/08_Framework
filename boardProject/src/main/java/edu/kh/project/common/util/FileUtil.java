...
public class FileUtil {
	...
	public static String rename(String originalFileName) {
		...
		// 원본 파일명 뒤에서부터 검색해서 처음 찾은 "."의 index부터 ㄱ
		int index = originalFileName.lastIndexOf(".");
		
		// 원본 파일명 "." 부터 끝까지 잘라낸 문자열 == .확장자
		String ext = originalFileName.substring(seqNum);
		...
		// new java.util.Date() : 현재시간을 저장한 객체 생성
		String time = sdf.format(new java.util.Date()); // 위에서 import구문 안쓰고 적용할때
