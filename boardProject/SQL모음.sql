...
SELECT RNUM
FROM ( 
    SELECT BOARD_NO, ROW_NUMBER() OVER (ORDER BY BOARD_NO DESC) RNUM
    FROM "BOARD"
    WHERE BOARD_CODE = 1
)
WHERE BOARD_NO = 2015;
