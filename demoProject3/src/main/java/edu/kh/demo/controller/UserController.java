...
public class UserController {
	...
	public String selectUserName(
		...
		// 사용자 이름 조회 서비스 호출후 결과 반환 받기
		String userName = service.selectUserName(userNo);
		
		// 조회 결과를 model에 추가
		model.addAttribute("userName", userName);
		
		// classpath:/templates/user/searchName.html 요청위임하기
	...
	/* RedirectAttributes
	 * - 리다이렉트시 request scope로 값을 전달할 수 있는
	 * 	 스프링 제공 객체
	 * 
	 * 
	 *	 [원리]
	 ...
	 * @param ra : redirect시 request scope로 값 전달하는 객체
	 * @return
	 */
	...
	/**
	 * 사용자 추가
	 * @param user : 제출된 값이 필드에 담겨진 "커맨트 객체"
